  ...
  const getControls = (layer: ExpandableLayerKey): ParamControl[] => {
    switch (layer) {
      ...
      case "osmSubstations": return [
        { label: `大小 ${osmSubstationsSize.toFixed(2)}`, value: osmSubstationsSize, min: 0.3, max: 3, step: 0.05, onChange: setOsmSubstationsSize },
