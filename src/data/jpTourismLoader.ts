...
export const JP_TOURISM_DATASETS: Record<JpTourismDataset, JpTourismDatasetConfig> = {
  "accommodation-canonical": {
    kind: "pmtiles", file: "jp_accommodation_canonical_allzoom_20260910.pmtiles", label: "旅宿去重總覽 宿泊施設の統合一覧",
    sourceLayer: "jp_accommodation_canonical", minzoom: 0, maxzoom: 14, production: true,
  },
  "accommodation-jta": {
    kind: "geojson", file: "jp_accommodation_jta_20260331.geojson", label: "觀光廳登錄旅宿 観光庁登録宿泊施設", production: true,
  },
  "accommodation-local": {
    kind: "geojson", file: "jp_accommodation_local_20260910.geojson", label: "地方旅館業許可 地方自治体の旅館業許可", production: true,
  },
  "accommodation-osm": {
    kind: "pmtiles", file: "jp_accommodation_osm_allzoom_20260910.pmtiles", label: "OSM 住宿 OSM 宿泊施設",
    sourceLayer: "jp_accommodation_osm", minzoom: 0, maxzoom: 14, production: true,
  },
  "natural-parks": {
    kind: "pmtiles", file: "jp_natural_parks_ksj_2010.pmtiles", label: "自然公園 自然公園（歷史版）",
    sourceLayer: "jp_natural_parks_ksj_2010", minzoom: 4, maxzoom: 12, production: false,
  },
  "nature-conservation": {
    kind: "pmtiles", file: "jp_nature_conservation_ksj_2015.pmtiles", label: "自然保育地域 自然保全地域（歷史版）",
    sourceLayer: "jp_nature_conservation_ksj_2015", minzoom: 4, maxzoom: 12, production: false,
  },
  "wildlife-protection": {
    kind: "pmtiles", file: "jp_wildlife_protection_moe_202504.pmtiles", label: "鳥獸保護區 鳥獣保護区",
    sourceLayer: "jp_wildlife_protection_moe_202504", minzoom: 4, maxzoom: 12, production: false,
  },
  "world-natural-heritage-historical": {
    kind: "geojson", file: "jp_world_natural_heritage_ksj_2011.geojson", label: "世界自然遺產 世界自然遺産（歷史版）", production: false,
  },
  "world-heritage-unesco": {
    kind: "geojson", file: "jp_world_heritage_unesco_current.geojson", label: "UNESCO 世界遺產 UNESCO 世界遺産", production: true,
    propertyDefaults: {
  ...
  ramsar: {
    kind: "geojson", file: "jp_ramsar_moe_current.geojson", label: "拉姆薩濕地 ラムサール条約湿地", production: false,
    propertyDefaults: { license_status: "LICENSE_UNVERIFIED", geometry_status: "HOLD_GEOMETRY" },
  },
  "marine-ebsa": {
    kind: "pmtiles", file: "jp_marine_ebsa_moe_coastal_20150101.pmtiles", label: "沿岸生態重要海域 沿岸EBSA",
