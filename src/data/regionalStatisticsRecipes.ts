...
const TAIPEI_BICYCLE_DIMENSIONS: Record<string, Record<string, string>> = {
  '2021-110-column1-0f49ea455993': { roc_year: '110', source_field: 'COLUMN1', geographic_coverage: 'taipei_township_only' },
  '2021-110-column3-99992a58ea8c': { roc_year: '110', source_field: 'COLUMN3', geographic_coverage: 'taipei_township_only' },
  '2021-110-column5-63628527a6e6': { roc_year: '110', source_field: 'COLUMN5', geographic_coverage: 'taipei_township_only' },
  '2021-110-column6-4267af9d1b14': { roc_year: '110', source_field: 'COLUMN6', geographic_coverage: 'taipei_township_only' },
  '2021-110-column7-e8e91f65c958': { roc_year: '110', source_field: 'COLUMN7', geographic_coverage: 'taipei_township_only' },
};
