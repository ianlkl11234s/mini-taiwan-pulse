...
export const JP_MEDICAL_CATEGORIES = [
  { value: "hospital", key: "jpMedicalHospitals", label: "醫院 病院", color: "#dc2626" },
  { value: "clinic", key: "jpMedicalClinics", label: "診所 診療所", color: "#2563eb" },
  { value: "dental", key: "jpMedicalDental", label: "牙科 歯科", color: "#8b5cf6" },
  { value: "maternity", key: "jpMedicalMaternity", label: "助產所 助産所", color: "#ec4899" },
  { value: "pharmacy", key: "jpMedicalPharmacies", label: "藥局 薬局", color: "#16a34a" },
] as const satisfies readonly { value: JpMedicalRecordKind; key: string; label: string; color: string }[];
...
export const JP_MEDICAL_CARE_GROUPS = [
  { key: "jpCarePlanning", label: "照護諮詢／計畫 介護の相談・ケアプラン", color: "#f59e0b", serviceTypes: ["居宅介護支援"] },
  { key: "jpCareHomeVisit", label: "到宅服務 自宅に訪問", color: "#0ea5e9", serviceTypes: ["訪問介護", "訪問入浴介護", "訪問看護", "訪問リハビリテーション", "定期巡回・随時対応型訪問介護看護", "夜間対応型訪問介護"] },
  { key: "jpCareDayServices", label: "日間服務 施設に通う", color: "#22c55e", serviceTypes: ["通所介護", "地域密着型通所介護", "認知症対応型通所介護", "通所リハビリテーション", "指定療養通所介護"] },
  { key: "jpCareResidential", label: "住宿／短期入住 施設で生活・宿泊", color: "#a855f7", serviceTypes: [
    "介護医療院", "介護療養型医療施設", "介護老人保健施設", "介護老人福祉施設",
    "地域密着型介護老人福祉施設入所者生活介護", "地域密着型特定施設入居者生活介護（有料老人ホーム（サービス付き高齢者向け住宅））",
  ...
  { key: "jpCareCombined", label: "複合服務 訪問・通い・宿泊の組合せ", color: "#f43f5e", serviceTypes: ["小規模多機能型居宅介護", "看護小規模多機能型居宅介護（複合型サービス）"] },
  { key: "jpCareEquipment", label: "福祉用具 福祉用具", color: "#14b8a6", serviceTypes: ["福祉用具貸与", "特定福祉用具販売"] },
] as const;
