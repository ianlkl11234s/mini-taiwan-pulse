...
export const LAYER_MANIFEST = {
  ...
  officialBridgesHsinchu: {
    ...
    dataClass: "B",
    source: { kind: "pmtiles", sourceId: "official-bridges-hsinchu", url: "./network_structures/official_bridges_hsinchu_20260924.pmtiles", sourceLayer: "official_bridges_hsinchu", minzoom: 7, maxzoom: 15 },
