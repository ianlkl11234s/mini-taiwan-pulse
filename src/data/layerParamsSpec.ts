...
export const LAYER_PARAMS_SPEC = {
  ...
  statsTaipeiUrbanRentalStations: [opacitySlider("statsTaipeiUrbanRentalStationsOpacity", 0.55)], statsTaipeiUrbanRentalTrips: [opacitySlider("statsTaipeiUrbanRentalTripsOpacity", 0.55)], statsTaipeiRiversideRentalStations: [opacitySlider("statsTaipeiRiversideRentalStationsOpacity", 0.55)], statsTaipeiRiversideBicycles: [opacitySlider("statsTaipeiRiversideBicyclesOpacity", 0.55)], statsTaipeiRiversideRentalTrips: [opacitySlider("statsTaipeiRiversideRentalTripsOpacity", 0.55)],
  statsA1AccidentCount: [opacitySlider("statsA1AccidentCountOpacity", 0.55)], statsA1DeathCount: [opacitySlider("statsA1DeathCountOpacity", 0.55)], statsA1InjuryCount: [opacitySlider("statsA1InjuryCountOpacity", 0.55)],
  statsAirportTakeoffsLandings: [opacitySlider("statsAirportTakeoffsLandingsOpacity", 0.55)], statsAirportPassengerMovements: [opacitySlider("statsAirportPassengerMovementsOpacity", 0.55)], statsAirportCargoTonnes: [opacitySlider("statsAirportCargoTonnesOpacity", 0.55)],
  statsTaoyuanAirportArrivals: [opacitySlider("statsTaoyuanAirportArrivalsOpacity", 0.55)], statsTaoyuanAirportDepartures: [opacitySlider("statsTaoyuanAirportDeparturesOpacity", 0.55)], statsTaoyuanAirportTransit: [opacitySlider("statsTaoyuanAirportTransitOpacity", 0.55)], statsTaoyuanAirportPassengerMovements: [opacitySlider("statsTaoyuanAirportPassengerMovementsOpacity", 0.55)],
