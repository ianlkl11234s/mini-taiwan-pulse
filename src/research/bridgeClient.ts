...
export type Scene = { camera: { center: [number, number]; zoom: number }; resultMode: "empty" | "synthetic"; layers?: Record<string, boolean>; nearby?: { queryId: string } | null };
