...
export interface LayerVisibility {
  ...
  statsDryFieldAreaTownship: boolean;
  statsOrchardAreaTownship: boolean;
  statsAgriculturalFacilityAreaTownship: boolean;
  statsCropPlantedAreaTownship: boolean;
  statsCropHarvestedAreaTownship: boolean;
  statsCropProductionTownship: boolean;
  statsCropYieldTownship: boolean;
  statsLivestockBuildingAreaTownship: boolean;
  statsPastureAreaTownship: boolean;
  statsLivestockFarmCountTownship: boolean;
  statsLivestockHeadCountTownship: boolean;
  statsAquacultureLandAreaTownship: boolean;
  statsFisheryProductionCounty: boolean;
  statsFisheryProductionValueCounty: boolean;
  statsAquacultureAreaCounty: boolean;
  statsConiferForestAreaTownship: boolean;
  statsBroadleafForestAreaTownship: boolean;
  statsBambooForestAreaTownship: boolean;
  statsMixedForestAreaTownship: boolean;
  statsRoadLandAreaTownship: boolean;
  statsRailLandAreaTownship: boolean;
  statsAirportLandAreaTownship: boolean;
  statsPortLandAreaTownship: boolean;
  ...
  statsTaipeiUrbanRentalStations: boolean;
  statsTaipeiUrbanRentalTrips: boolean;
  statsTaipeiRiversideRentalStations: boolean;
  statsTaipeiRiversideBicycles: boolean;
  statsTaipeiRiversideRentalTrips: boolean;
  statsA1AccidentCount: boolean;
  statsA1DeathCount: boolean;
  statsA1InjuryCount: boolean;
  statsAirportTakeoffsLandings: boolean;
  statsAirportPassengerMovements: boolean;
  statsAirportCargoTonnes: boolean;
  statsTaoyuanAirportArrivals: boolean;
  statsTaoyuanAirportDepartures: boolean;
  statsTaoyuanAirportTransit: boolean;
  statsTaoyuanAirportPassengerMovements: boolean;
  ...
  publicLibraries: boolean;
  welfareCenters: boolean;
  /** 動物認領養每日快照：收容所摘要點位，數量不是即時值 */
  ...
  // 🎭 文化 Culture（靜態 overlay GeoJSON 點；4 獨立 layer）
  culturalFacilities: boolean;    // 文化設施全國（787 點，facility_type 6 類：實體書店/工藝之家/博物館/特色圖書館/文化行政據點/文創商店 categorical 染色 + 分類篩選）
