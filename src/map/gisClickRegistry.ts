...
export const GIS_LAYERS: { layers: string[]; type: FeatureInfo["layerType"] }[] = [
  ...
  // 🌍 世界 WORLD
  { layers: ["global-events-current-circle", "global-events-relations-line"], type: "globalEvent" },
  ...
  { layers: ["statsWasteCounty-fill", "statsRecyclingCounty-fill", "statsWasteRecyclingRate-fill", "statsResidentialElectricity-fill", "statsRiceHarvest-fill", "statsBirthsTownship-fill", "statsPigWaterCounty-fill", "statsWaterSupplyHistorical-fill", "statsMaritimeSubsidyCounty-fill", "statsCivilAeronauticsSubsidyCounty-fill", "statsTaipeiTrafficViolationCitations-fill", "statsTaichungRoadNoiseMonitoringStations-fill", "statsBusOperatingRouteLengthKm-fill", "statsBusApprovedRouteCount-fill", "statsUrbanBusOperatorCount-fill", "statsBusOperatingVehicleCount-fill", "statsBusAccessibleVehicleCount-fill", "statsBusElectricVehicleCount-fill", "statsBusOperatingTripCount-fill", "statsBusOperatingVehicleKm-fill", "statsTmrtStationOutboundCounty-fill", "statsTaipeiUrbanRentalStations-fill", "statsTaipeiUrbanRentalTrips-fill", "statsTaipeiRiversideRentalStations-fill", "statsTaipeiRiversideBicycles-fill", "statsTaipeiRiversideRentalTrips-fill", "statsA1AccidentCount-fill", "statsA1DeathCount-fill", "statsA1InjuryCount-fill", "statsAirportTakeoffsLandings-fill", "statsAirportPassengerMovements-fill", "statsAirportCargoTonnes-fill", "statsTaoyuanAirportArrivals-fill", "statsTaoyuanAirportDepartures-fill", "statsTaoyuanAirportTransit-fill", "statsTaoyuanAirportPassengerMovements-fill", "statsOffstreetSmallCarParkingSpacesCount-fill", "statsOnstreetSmallCarParkingSpacesCount-fill", "statsMotorcycleRegisteredCount-fill", "statsAutomobileRegisteredCount-fill", "statsAutomobileLicenseHoldersCount-fill", "statsMotorcycleLicenseHoldersCount-fill"], type: "regionalStatistic" },
