...
export const PANEL_REGISTRY: Partial<Record<FeatureInfo["layerType"], FC<PanelProps>>> = {
  ...
  jpMedicalHospitals: JpMedicalFacilitiesPanel,
  jpMedicalClinics: JpMedicalFacilitiesPanel,
  jpMedicalDental: JpMedicalFacilitiesPanel,
  jpMedicalMaternity: JpMedicalFacilitiesPanel,
  jpMedicalPharmacies: JpMedicalFacilitiesPanel,
  jpCarePlanning: JpMedicalCarePanel,
  jpCareHomeVisit: JpMedicalCarePanel,
  jpCareDayServices: JpMedicalCarePanel,
  jpCareResidential: JpMedicalCarePanel,
  jpCareCombined: JpMedicalCarePanel,
  jpCareEquipment: JpMedicalCarePanel,
  jpMedicalAreasPrimary: JpMedicalAreasPanel,
  jpMedicalAreasSecondary: JpMedicalAreasPanel,
  jpMedicalAreasTertiary: JpMedicalAreasPanel,
  ...
  jpNaturalParksNational: JpTourismPanel,
  jpNaturalParksQuasiNational: JpTourismPanel,
  jpNaturalParksPrefectural: JpTourismPanel,
  jpNatureConservationArea: JpTourismPanel,
  jpPrimitiveNatureEnvironmentArea: JpTourismPanel,
  jpNatureConservationSpecialDistrict: JpTourismPanel,
  jpWildlifeProtectionNational: JpTourismPanel,
  jpWildlifeSpecialProtectionDistrict: JpTourismPanel,
  jpWildlifeSpecialProtectionDesignatedArea: JpTourismPanel,
  jpWorldHeritageCultural: JpTourismPanel,
  jpWorldHeritageNatural: JpTourismPanel,
  jpWorldNaturalHeritageHistorical: JpTourismPanel,
  jpRamsarSites: JpTourismPanel,
  jpMarineEbsaCoastal: JpTourismPanel,
...
export const HEADER_LABELS: Record<FeatureInfo["layerType"], string> = {
  ...
  worldTrashDebris: "垃圾與殘骸觀測 Trash & Debris Observations",
  ...
  jpMedicalHospitals: "醫院 病院",
  jpMedicalClinics: "診所 診療所",
  jpMedicalDental: "牙科 歯科",
  jpMedicalMaternity: "助產所 助産所",
  jpMedicalPharmacies: "藥局 薬局",
  jpCarePlanning: "照護諮詢／計畫 介護の相談・ケアプラン",
  jpCareHomeVisit: "到宅服務 自宅に訪問",
  jpCareDayServices: "日間服務 施設に通う",
  jpCareResidential: "住宿／短期入住 施設で生活・宿泊",
  jpCareCombined: "複合服務 訪問・通い・宿泊の組合せ",
  jpCareEquipment: "福祉用具 福祉用具",
  jpMedicalAreasPrimary: "一次醫療圈 一次医療圏 · 2020",
  jpMedicalAreasSecondary: "二次醫療圈 二次医療圏 · 2020",
  jpMedicalAreasTertiary: "三次醫療圈 三次医療圏 · 2020",
  jpReligionGsi: "宗教設施 宗教施設（国土地理院）",
  jpReligionOsm: "宗教設施 宗教施設（OpenStreetMap）",
  jpReligionWikidata: "宗教設施 宗教施設（Wikidata）",
  jpAdminPrefecture: "都道府縣界 都道府県境",
  jpAdminBoundaries: "市區町村界 市区町村境",
  jpStations: "車站 駅",
  jpAirports: "機場 空港",
  ...
  jpAccommodationDensity: "旅宿密度網格 宿泊施設密度グリッド",
  jpAccommodationJta: "觀光廳登錄飯店／旅館 観光庁登録ホテル・旅館",
  jpAccommodationLocal: "地方旅館業許可 地方自治体の旅館業許可",
  jpAccommodationOsm: "OpenStreetMap 住宿涵蓋 OpenStreetMap 宿泊施設カバレッジ",
  jpNaturalParksNational: "國立公園 国立公園（A10 2010）",
  jpNaturalParksQuasiNational: "國定公園 国定公園（A10 2010）",
  jpNaturalParksPrefectural: "都道府縣立自然公園 都道府県立自然公園（A10 2010）",
  jpNatureConservationArea: "自然保育地域 自然保全地域（A11 2015）",
  jpPrimitiveNatureEnvironmentArea: "原生自然環境地域 原生自然環境保全地域（A11 2015）",
  jpNatureConservationSpecialDistrict: "自然保育特別地區 自然保全特別地区（A11 2015）",
  jpWildlifeProtectionNational: "國家指定鳥獸保護區 国指定鳥獣保護区",
  jpWildlifeSpecialProtectionDistrict: "鳥獸特別保護地區 鳥獣保護区特別保護地区",
  jpWildlifeSpecialProtectionDesignatedArea: "鳥獸特別保護指定區域 特別保護指定区域",
  jpWorldHeritageCultural: "UNESCO 文化遺產代表點 UNESCO 文化遺産代表点",
  jpWorldHeritageNatural: "UNESCO 自然遺產代表點 UNESCO 自然遺産代表点",
  jpWorldNaturalHeritageHistorical: "世界自然遺產歷史範圍 世界自然遺産の歴史的範囲（A28 2011）",
  jpRamsarSites: "拉姆薩濕地名冊衍生點 ラムサール条約湿地名簿の派生点",
  jpMarineEbsaCoastal: "沿岸生態重要海域 沿岸EBSA（2015）",
