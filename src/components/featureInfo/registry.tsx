...
export const HEADER_LABELS: Record<FeatureInfo["layerType"], string> = {
  ...
  jpNaturalParksNational: "國立公園（A10 historical）",
  jpNaturalParksQuasiNational: "國定公園（A10 historical）",
  jpNaturalParksPrefectural: "都道府縣立自然公園（A10 historical）",
  jpNatureConservationArea: "自然保全地域（A11 historical）",
  jpPrimitiveNatureEnvironmentArea: "原生自然環境地域（A11 historical）",
  jpNatureConservationSpecialDistrict: "自然保全特別地區（A11 historical）",
  jpWildlifeProtectionNational: "國指定鳥獸保護區",
  jpWildlifeSpecialProtectionDistrict: "鳥獸特別保護地區",
  jpWildlifeSpecialProtectionDesignatedArea: "鳥獸特別保護指定地域",
  jpWorldHeritageCultural: "UNESCO 文化遺產代表點",
  jpWorldHeritageNatural: "UNESCO 自然遺產代表點",
  jpWorldNaturalHeritageHistorical: "世界自然遺產面（A28 historical）",
  jpRamsarSites: "Ramsar 濕地名冊衍生點",
  jpMarineEbsaCoastal: "沿岸生態重要海域 EBSA",
