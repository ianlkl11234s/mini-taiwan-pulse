...
describe("STATISTICS_TAB_THEMES", () => {
  ...
  it("只聚合目前已接線的行政區統計與邊界圖層", () => {
    expect(layers.map((layer) => layer.key)).toEqual([
      ...
      "statsBusOperatingRouteLengthKm",
      "statsBusApprovedRouteCount",
      "statsUrbanBusOperatorCount",
      "statsBusOperatingVehicleCount",
      "statsBusAccessibleVehicleCount",
      "statsBusElectricVehicleCount",
      ...
      "statsA1AccidentCount", "statsA1DeathCount", "statsA1InjuryCount",
      "statsAirportTakeoffsLandings", "statsAirportPassengerMovements", "statsAirportCargoTonnes",
      ...
      "statsAquacultureLandAreaTownship", "statsFisheryProductionCounty", "statsFisheryProductionValueCounty", "statsAquacultureAreaCounty",
