...
| 週次 | Supabase | live schema | S3 | 慢 RPC(>200ms) | 真斷更表 | 線上 404 | 孤兒資產 | 🔴 | 🟡 |
|---|---|---|---|---|---|---|---|---|---|
| [2026-W34](2026-W34.md) | 37 GB | 509 表 / 33 GB | 3.74 GB / US$0.09 | 40（無基準） | 0 | 2（刻意下架） | 41 / 809 MB | 0 | 17 |
| [2026-W38](2026-W38.md) | 39 GB | 657 表 / 32 GB | 9.96 GB / US$0.25 | 40（snapshot） | 待人工判讀 | 未完成全資產 sweep | 待引用核對 | 0 | 見報告 |
