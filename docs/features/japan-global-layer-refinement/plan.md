...
| PR 5 日本／全球命名與分組 | 本 PR | layer key、source 與 asset path 不變；35 focused passed；`tsc -b`；全套 1,603 passed / 8 skipped；build passed；desktop 全球 5 主題與日本中日文名稱 PASS；390x844 mobile 無「世界」大分組 PASS；正確 env 啟動後無新增 console error | 待 CI 與一般 merge commit |
