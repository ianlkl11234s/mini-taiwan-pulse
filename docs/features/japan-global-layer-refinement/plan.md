...
| PR 7 不動產總市值統計 | #295 / `52c26493` | `tsc -b`；全套 1,605 passed / 8 skipped，新增 layer golden 15/15；build passed；desktop 縣市／鄉鎮市區色階、legend、popup；390x844 Statistics 控制與說明 PASS | PR 已建立；待 CI 與一般 merge commit |
