...
維護入口：[統計圖層維護與驗收規則](../../statistics-layer-guidelines.md)。涵蓋配色、icon、UI、資料來源總覽及發布驗收。

## 發布紀錄與目前追加項目

2026-09-17 已完成 244 組新增 selectors 的增量 CDN 發布（保留既有 3,590，合計 3,834），並由 PR #256 的 merge `9c5937ae` 啟用正式比較 UI；當時部署驗收為 RUNNING。這是該次發布紀錄，不代替即時服務健康檢查。

PR #258 追加清單樣式、語意 icon、主題色階及資料來源總覽；尚未合併的內容以該 PR 與 [changelog](./changelog.md) 為準。

以下保留復原時的本地資料契約與歷史驗收；LOCAL_ONLY 描述當時生成物，不代表後續仍未發布。
