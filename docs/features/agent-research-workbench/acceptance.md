> **歷史文件（2026-09-14～15）**：保留 Research Workbench 當時的本地驗收證據，不代表目前工具數、跟隨行為或發布狀態。現在請從 [探索能力計劃](./exploration-capabilities-plan.md) 進入；工具快照見 [全圖層能力盤點](./layer-capability-inventory-20260919.md)。
