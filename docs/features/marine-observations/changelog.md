...
- 修正多指標站 popup 與展開圖例的總高度溢出；右下 stack 維持 viewport 邊界，popup 內容可獨立捲動。
- 完成本地 typecheck、unit、build、production RPC smoke 與 localhost browser 驗收；尚未 push、PR、merge 或 deploy。
