...
- [x] B1/A4 shared-source、z12 gate、capital_q 固定色與 A4 exact filter。
- [x] B2 三模式與 null median neutral。
- [x] B3 production subset：89 行業、縣市、資本額分位、設立年與所有 boolean/tri-state flags。
