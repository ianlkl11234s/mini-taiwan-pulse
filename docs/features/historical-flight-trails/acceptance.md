...
- PR #316 以一般 merge commit `9b6e9d88` 整合，Zeabur deployment `6aae9e2f` 為 `RUNNING`。Production manifest 為 68,673 bytes、SHA-256 `80e648b9…`、`application/json`、短快取；桃園 02/20、02/24、02/18 與羽田 02/18 資產皆與 manifest bytes／SHA 完全相符，為 `application/geo+json` 與一年 immutable cache。見 [`evidence/20260919-v2-production-deployment.json`](evidence/20260919-v2-production-deployment.json) 與 [`evidence/20260919-v2-production-http-readback.json`](evidence/20260919-v2-production-http-readback.json)。
- Production desktop browser 驗證全部機場預設 02/20；02/20、02/24、02/18 均完成載入並分別顯示 16/17、16/17、14/17 機場可用。藍白 3D 航跡可見、沒有軌跡點 marker，console error／warning 均為 0，最後恢復預設 02/20。見 [`evidence/20260920-v2-production-browser.json`](evidence/20260920-v2-production-browser.json)。
