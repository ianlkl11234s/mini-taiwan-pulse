...
| G012 | P1 | tourism D 類 3 檔 + canopy 高度 pmtiles（80MB）上 S3 | open | 2026-07-24 部署 blocker：#82/#83 已 merged，prod 部署前須跑 upload-deploy-assets.sh tourism 段 + canopy pmtiles 上 S3/Volume，否則 attractions/hotels/restaurants + canopyHeight 4 層 404（其餘 9 層 C 類在 git 不受影響） |
